...
Write-Host ""
Write-Host "Tips:"
Write-Host "- Restore latest backup: .\scripts\restore.ps1"
Write-Host "- Restore specific backup: .\scripts\restore.ps1 -BackupPath .\backups\20260419_123000"
Write-Host "- Also restore models: .\scripts\restore.ps1 -RestoreModels"
Write-Host "- Start all services after restore: .\scripts\restore.ps1 -StartStack"
